...
% =========================================================
    ...
    % main function to calculate the required hydraulic pin size
    function PinDim = PinDim(M_k, w_ball, r_ball, d_hydraulic)

        % Force acting on the pins
        F = HydrPin.F_max(M_k, r_ball) * 3; % multiply by three to account for higher load conditions like running or jumping
